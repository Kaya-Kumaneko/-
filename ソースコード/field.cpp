...
void Field::Init()
{
	...
	vertex[0].Position = D3DXVECTOR3(-1000.0f, 0.0f, 1000.0f);
	vertex[0].Normal = D3DXVECTOR3(0.0f, 1.0f, 0.0f);
	vertex[0].Diffuse = D3DXVECTOR4(1.0f, 1.0f, 1.0f, 1.0f);
	vertex[0].TexCoord = D3DXVECTOR2(0.0f, 0.0f);

	vertex[1].Position = D3DXVECTOR3(1000.0f, 0.0f, 1000.0f);
	vertex[1].Normal = D3DXVECTOR3(0.0f, 1.0f, 0.0f);
	vertex[1].Diffuse = D3DXVECTOR4(1.0f, 1.0f, 1.0f, 1.0f);
	vertex[1].TexCoord = D3DXVECTOR2(100.0f, 0.0f);

	vertex[2].Position = D3DXVECTOR3(-1000.0f, 0.0f, -1000.0f);
	vertex[2].Normal = D3DXVECTOR3(0.0f, 1.0f, 0.0f);
	vertex[2].Diffuse = D3DXVECTOR4(1.0f, 1.0f, 1.0f, 1.0f);
	vertex[2].TexCoord = D3DXVECTOR2(0.0f, 100.0f);

	vertex[3].Position = D3DXVECTOR3(1000.0f, 0.0f, -1000.0f);
	...
	D3DX11CreateShaderResourceViewFromFile(Renderer::GetDevice(),
		"asset\\texture\\field\\ground01_diff.jpg",
		NULL,
		NULL,
		&m_Texture,
		NULL);
