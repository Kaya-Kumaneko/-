...
void LoadingLogo2::Init()
{
	...
	D3DX11CreateShaderResourceViewFromFile(Renderer::GetDevice(),
		"asset\\texture\\loading\\loading02.jpg",
		NULL,
		NULL,
		&m_Texture,
		NULL);
...
void LoadingLogo2::Update()
{

}

void LoadingLogo2::Draw()
{
	// 入力レイアウト設定
